...
public:
    ...
    kglt::MeshID generate_test_mesh(kglt::StagePtr stage) {
        kglt::MeshID mid = stage->resources->new_mesh(kglt::VertexSpecification::POSITION_ONLY);
    ...
    void test_mesh_normalization() {
        ...
        auto mesh = stage->resources->mesh(generate_test_mesh(stage));
    ...
    void test_scene_methods() {
        ...
        kglt::MeshID mesh_id = stage->resources->new_mesh(kglt::VertexSpecification::POSITION_ONLY); //Create a mesh
    ...
    void test_cubic_texture_generation() {
        ...
        auto mesh_id = stage->resources->new_mesh_as_box(10.0f, 10.0f, 10.0f);
        stage->resources->mesh(mesh_id)->only_submesh()->generate_texture_coordinates_cube();

        auto& vd = *stage->resources->mesh(mesh_id)->only_submesh()->vertex_data.get();
