...
void MaterialObject::set_specular(const Colour &colour) {
    override_property_value(SPECULAR_PROPERTY_NAME, (const Vec4&) colour);
}

void MaterialObject::set_ambient(const Colour &colour) {
    override_property_value(AMBIENT_PROPERTY_NAME, (const Vec4&) colour);
}

void MaterialObject::set_emission(const Colour& colour) {
    override_property_value(EMISSION_PROPERTY_NAME, (const Vec4&) colour);
}

void MaterialObject::set_diffuse(const Colour &colour) {
    override_property_value(DIFFUSE_PROPERTY_NAME, (const Vec4&) colour);
}
...
void MaterialObject::set_shininess(float shininess) {
    ...
    override_property_value(SHININESS_PROPERTY_NAME, clamp(shininess, 0, 128));
}

void MaterialObject::set_diffuse_map(TexturePtr texture) {
    override_property_value(DIFFUSE_MAP_PROPERTY_NAME, texture);
}

void MaterialObject::set_light_map(TexturePtr texture) {
    override_property_value(LIGHT_MAP_PROPERTY_NAME, texture);
}

void MaterialObject::set_diffuse_map_matrix(const Mat4& mat) {
    override_property_value(DIFFUSE_MAP_MATRIX_PROPERTY_NAME, mat);
}

void MaterialObject::set_light_map_matrix(const Mat4& mat) {
    override_property_value(LIGHT_MAP_MATRIX_PROPERTY_NAME, mat);
}

void MaterialObject::set_normal_map_matrix(const Mat4& mat) {
    override_property_value(NORMAL_MAP_MATRIX_PROPERTY_NAME, mat);
}

void MaterialObject::set_specular_map_matrix(const Mat4& mat) {
    override_property_value(SPECULAR_MAP_MATRIX_PROPERTY_NAME, mat);
}
...
void MaterialObject::set_blend_func(BlendType b) {
    override_property_value(BLEND_FUNC_PROPERTY_NAME, (const EnumType&) b);
}
...
void MaterialObject::set_depth_write_enabled(bool v) {
    override_property_value(DEPTH_WRITE_ENABLED_PROPERTY_NAME, v);
}
...
void MaterialObject::set_cull_mode(CullMode mode) {
    override_property_value(CULL_MODE_PROPERTY_NAME, (const EnumType&) mode);
}
...
void MaterialObject::set_depth_test_enabled(bool v) {
    override_property_value(DEPTH_TEST_ENABLED_PROPERTY_NAME, v);
}
...
void MaterialObject::set_lighting_enabled(bool v) {
    override_property_value(LIGHTING_ENABLED_PROPERTY_NAME, v);
}
...
void MaterialObject::set_texturing_enabled(bool v) {
    override_property_value(TEXTURING_ENABLED_PROPERTY_NAME, v);
}
...
void MaterialObject::set_polygon_mode(PolygonMode mode) {
    override_property_value(POLYGON_MODE_PROPERTY_NAME, (const EnumType&) mode);
}
...
void MaterialObject::set_shade_model(ShadeModel model) {
    override_property_value(SHADE_MODEL_PROPERTY_NAME, (const EnumType&) model);
}
...
void MaterialObject::set_colour_material(ColourMaterial cm) {
    override_property_value(COLOUR_MATERIAL_PROPERTY_NAME, (const EnumType&) cm);
}
