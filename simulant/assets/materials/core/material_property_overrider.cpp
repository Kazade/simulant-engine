...
static inline bool fetcher(const MaterialPropertyOverrider* const _S_RESTRICT _this, const MaterialPropertyOverrider* const __restrict parent, const Map & map, MaterialPropertyNameHash hsh, const T * &out) {
