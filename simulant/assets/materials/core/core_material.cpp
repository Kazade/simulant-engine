...
bool core_property_type(MaterialPropertyNameHash hsh, MaterialPropertyType* type) {
    ...
    switch(hsh) {
        case material_property_hash(BASE_COLOR_PROPERTY_NAME):
        case material_property_hash(SPECULAR_COLOR_PROPERTY_NAME):
        ...
        break;
        case material_property_hash(BASE_COLOR_MAP_PROPERTY_NAME):
        case material_property_hash(METALLIC_ROUGHNESS_MAP_PROPERTY_NAME):
        ...
        break;
        case material_property_hash(BASE_COLOR_MAP_MATRIX_PROPERTY_NAME):
        case material_property_hash(
...
const PropertyList& core_properties() {
    static const PropertyList core_properties = {
        ...
        {SPECULAR_COLOR_PROPERTY_NAME,                MATERIAL_PROPERTY_TYPE_VEC4   },

        {SPECULAR_PROPERTY_NAME,                      MATERIAL_PROPERTY_TYPE_FLOAT  },
        ...
        {BASE_COLOR_MAP_PROPERTY_NAME,                MATERIAL_PROPERTY_TYPE_TEXTURE},
        {METALLIC_ROUGHNESS_MAP_PROPERTY_NAME,        MATERIAL_PROPERTY_TYPE_TEXTURE},
        {LIGHT_MAP_PROPERTY_NAME,                     MATERIAL_PROPERTY_TYPE_TEXTURE},
        {NORMAL_MAP_PROPERTY_NAME,                    MATERIAL_PROPERTY_TYPE_TEXTURE},

        {BASE_COLOR_MAP_MATRIX_PROPERTY_NAME,         MATERIAL_PROPERTY_TYPE_MAT4   },
        {METALLIC_ROUGHNESS_MAP_MATRIX_PROPERTY_NAME,
         MATERIAL_PROPERTY_TYPE_MAT4                                                },
        {LIGHT_MAP_MATRIX_PROPERTY_NAME,              MATERIAL_PROPERTY_TYPE_MAT4   },
        {NORMAL_MAP_MATRIX_PROPERTY_NAME,             MATERIAL_PROPERTY_TYPE_MAT4   },
