...
public:
    ...
    smlt::MeshID debug_mesh_id() { return debug_mesh_; }
...
private:
    ...
    smlt::MeshID debug_mesh_;
    smlt::MaterialID debug_material_;

    std::unordered_map<OctreeNode*, smlt::SubMesh*> debug_submeshes_;
