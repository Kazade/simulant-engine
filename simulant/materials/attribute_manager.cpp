...
VertexAttributeType convert(ShaderAvailableAttributes attr) {
     ...
     */
    switch(attr) {
        case SP_ATTR_VERTEX_POSITION: return VERTEX_ATTR_TYPE_POSITION;
        case SP_ATTR_VERTEX_NORMAL: return VERTEX_ATTR_TYPE_NORMAL;
        case SP_ATTR_VERTEX_TEXCOORD0: return VERTEX_ATTR_TYPE_TEXCOORD0;
        case SP_ATTR_VERTEX_TEXCOORD1: return VERTEX_ATTR_TYPE_TEXCOORD1;
        case SP_ATTR_VERTEX_TEXCOORD2: return VERTEX_ATTR_TYPE_TEXCOORD2;
        case SP_ATTR_VERTEX_TEXCOORD3: return VERTEX_ATTR_TYPE_TEXCOORD3;
        case SP_ATTR_VERTEX_DIFFUSE: return VERTEX_ATTR_TYPE_DIFFUSE;
        case SP_ATTR_VERTEX_SPECULAR: return VERTEX_ATTR_TYPE_SPECULAR;
    default:
        return VERTEX_ATTR_TYPE_EMPTY;
    }
