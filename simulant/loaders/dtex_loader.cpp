...
TextureLoadResult DTEXLoader::do_load(std::shared_ptr<FileIfstream> stream) {
    ...
    switch(format) {
        case 0:
            ...
            lookup[COMPRESSED_MASK | MIPMAPPED_MASK] = TEXTURE_FORMAT_ARGB_1US_1555_VQ_TWID;
            lookup[COMPRESSED_MASK | TWIDDLED_MASK | MIPMAPPED_MASK] = TEXTURE_FORMAT_ARGB_1US_1555_VQ_TWID;
        ...
        case 1:
            ...
            lookup[COMPRESSED_MASK | MIPMAPPED_MASK] = TEXTURE_FORMAT_RGB_1US_565_VQ_TWID;
            lookup[COMPRESSED_MASK | TWIDDLED_MASK | MIPMAPPED_MASK] = TEXTURE_FORMAT_RGB_1US_565_VQ_TWID;
        ...
        case 2:
            ...
            lookup[COMPRESSED_MASK | MIPMAPPED_MASK] = TEXTURE_FORMAT_ARGB_1US_4444_VQ_TWID;
            lookup[COMPRESSED_MASK | TWIDDLED_MASK | MIPMAPPED_MASK] = TEXTURE_FORMAT_ARGB_1US_4444_VQ_TWID;
