...
namespace loaders {
    ...
    void TTFLoader::into(Loadable& resource, const LoaderOptions& options) {
         ...
         * 150kb - essential for memory constrained systems. */
            ...
            auto texture = font->pages_[current_page].texture = font->asset_manager().new_texture(
                width,
                width,
            ...
            font->pages_[current_page].material = font->asset_manager().new_material_from_file(Material::BuiltIns::TEXTURE_ONLY);
