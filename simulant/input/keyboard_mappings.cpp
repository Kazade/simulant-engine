...
KeyboardMap UK[] = {
    ...
    {KEYBOARD_CODE_0,              true,  ')'  },
    {KEYBOARD_CODE_1,              false, '1'  },
    {KEYBOARD_CODE_1,              true,  '!'  },
    ...
    {KEYBOARD_CODE_GRAVE,          false, '`'  },
    {KEYBOARD_CODE_GRAVE,          true,  u'¬'},
};
