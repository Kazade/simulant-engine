...
public:
    ...
    void set_joystick_source(GameControllerID joystick);
    GameControllerID joystick_source() const { return joystick_source_; }
...
private:
    ...
    GameControllerID joystick_source_ = ALL_JOYSTICKS;
