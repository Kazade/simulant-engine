...
public:
    ...
    virtual void render(CameraPtr camera, StagePtr stage, const new_batcher::RenderGroup*, const new_batcher::RenderGroup*, Renderable*, MaterialPass*, new_batcher::Iteration) = 0;
